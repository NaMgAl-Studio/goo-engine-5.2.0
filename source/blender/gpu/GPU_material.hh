...
enum eGPUMaterialFlag {
  ...
  /* Goo Engine: material uses the Set Depth node (writes a per-pixel depth via gl_FragDepth on a
   * dedicated non-early-Z surface variant). */
  GPU_MATFLAG_SET_DEPTH = (1 << 12),

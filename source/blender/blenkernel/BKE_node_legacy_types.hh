...
/* Goo Engine ported node types. Original Goo Engine IDs are preserved so that
 * Goo .blend files map these node types on load. Nodes are registered
 * incrementally; see goo_to_eevee52_bridge/IMPL_B.md. */

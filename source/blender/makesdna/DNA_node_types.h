...
/* Goo Engine: Water Ripples texture node modes. */
enum eNodeWaterRipplesMode {
...
struct NodeWaterRipples {
  DNA_DEFINE_CXX_METHODS(NodeWaterRipples)
...
/* Goo Engine: Hex Grid Texture node modes. */
enum {
...
/* Goo Engine: SDF Operator node operations. */
enum {
  SHD_SDF_OP_DILATE = 0,
  SHD_SDF_OP_ONION = 1,
  SHD_SDF_OP_BLEND = 2,
...
/* Goo Engine: SDF Vector Operator node operations. */
enum {
...
/* Goo Engine: SDF Primitive node shape modes. */
enum {
  SHD_SDF_2D_CIRCLE = 0,
...
/* Goo Engine: Shader Info node (per-node light groups). */
struct NodeShaderInfo {
  DNA_DEFINE_CXX_METHODS(NodeShaderInfo)

  int light_group_bits[4];
  int light_group_shadow_bits[4];
  int use_own_light_groups;
  char _pad[4];
};

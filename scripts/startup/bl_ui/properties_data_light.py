...
class DATA_PT_EEVEE_light_shadow_contact(DataButtonsPanel, Panel):
    # Goo Engine: legacy contact shadows (consumed by the Shader Info bridge).
    bl_label = "Contact Shadows"
    bl_parent_id = "DATA_PT_EEVEE_light_shadow"
    bl_options = {'DEFAULT_CLOSED'}
    COMPAT_ENGINES = {'BLENDER_EEVEE'}
    ...
    def draw(self, context):
        ...
        layout.use_property_split = True
        layout.active = (
            context.scene.eevee.use_shadows and light.use_shadow and light.use_contact_shadow
        )
...
classes = (
    ...
    DATA_PT_EEVEE_light_shadow_contact,
